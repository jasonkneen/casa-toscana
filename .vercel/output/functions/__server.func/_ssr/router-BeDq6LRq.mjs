...
import { $t as runWithAdapter, At as object, Bt as normalizePathname, C as serializeSignedCookie, Ct as any, D as decodeJwt, Dt as literal, E as base64Url, Et as email, Gt as ATTR_CONTEXT, Jt as import_src, Kt as ATTR_HOOK_TYPE, Lt as betterFetch, Mt as record, Nt as string, O as decodeProtectedHeader, Ot as looseObject, Pt as union, Q as encode, Qt as queueAfterTransactionHook, S as serializeCookie, Tt as boolean, Wt as withSpan, Xt as getAuthTables, Yt as safeJSONParse, Zt as getCurrentAdapter, _ as runWithRequestState, _n as BetterAuthError, a as createAuthorizationURL, an as createRandomStringGenerator, b as createRouter$1, bn as defineErrorCodes, c as createRateLimitKey, cn as shouldPublishLog, d as deprecate, en as runWithTransaction, f as createAuthEndpoint, g as hasRequestState, gn as APIError, h as defineRequestState, hn as isTest, i as refreshAccessToken, in as generateId, jt as optional, k as jwtVerify, kt as number, l as findInvalidTrustedProxies, m as isAPIError, mn as isProduction, n as socialProviders, nn as initGetModelName, o as applyDefaultAccessTokenExpiry, on as createLogger, p as createAuthMiddleware, pn as isDevelopment, qt as ATTR_OPERATION_ID, r as validateAuthorizationCode, rn as initGetFieldName, s as isLoopbackHost, sn as logger, t as SocialProviderListEnum, tn as getBetterAuthVersion, u as getIp, un as env, ut as JWTExpired, v as getCurrentAuthContext, vn as kAPIErrorHeaderSymbol, w as filterOutputFields, wt as array, x as toResponse, y as runWithEndpointContext, yn as BASE_ERROR_CODES } from "../_libs/@better-auth/core+[...].mjs";
...
//#region node_modules/.nitro/vite/services/ssr/assets/router-BeDq6LRq.js
var router_BeDq6LRq_exports = /* @__PURE__ */ __exportAll({
	a: () => PACKAGE_VERSION,
	getRouter: () => getRouter,
	i: () => GENERIC_OAUTH_ERROR_CODES,
	n: () => GROK_PROVIDERS,
	r: () => getBaseURL,
	t: () => router_exports
});
...
var styles_default = "/assets/styles-C-DSl19k.css";
var APP_NAME = "Casa Toscana";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Game-ready Three.js Florentine townhouse — inspect, orbit, and export GLB."
			},
			{
...
var $$splitComponentImporter$1 = () => import("./routes-xqRxgdDK.mjs");
var Route$2 = createFileRoute("/")({
	ssr: false,
	component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
var $$splitComponentImporter = () => import("./login-BYfbYw7A.mjs");
...
//#endregion
export { router_BeDq6LRq_exports as a, getBaseURL as i, GROK_PROVIDERS as n, PACKAGE_VERSION as r, GENERIC_OAUTH_ERROR_CODES as t };
